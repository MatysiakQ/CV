const translations = {
  en: {
    ...
    // Home Page
    'home.hero.title': 'Software Engineer & Technical Founder',
    'home.hero.description': 'I build products and systems that turn complex workflows into reliable software. From mobile apps to backend systems, I deliver end-to-end solutions with automation, clean architecture, and production-ready code.',
    'home.hero.viewProjects': 'View Featured Work',
    'home.hero.contactMe': 'Start a Project',
    'home.hero.downloadCV': 'Download CV',
    'home.about.title': 'About Me',
    'home.about.description': 'Experienced software engineer focused on building scalable systems and products. I combine frontend expertise with strong backend skills, system architecture, and a deep understanding of the full software lifecycle.',
    'home.about.cyberskiller.title': 'Systems & Security Minded',
    'home.about.cyberskiller.subtitle': 'I build resilient applications with security-first approach, reliable architecture, and deep system understanding.',
    ...
    // About Page
    'about.service.frontend.title': 'Full-Stack Development',
    'about.service.frontend.description': 'I build complete web applications from frontend to backend, ensuring seamless integration and performance.',
    'about.service.backend.title': 'System Architecture',
    'about.service.backend.description': 'I design scalable APIs, databases, and cloud infrastructure for robust, production-ready systems.',
    'about.service.mobile.title': 'Mobile & Cross-Platform',
    'about.service.mobile.description': 'I develop native and cross-platform mobile apps with focus on performance, offline capabilities, and user experience.',
    'about.service.design.title': 'Product Engineering',
    'about.service.design.description': 'I engineer products with clean architecture, automation, and deep understanding of business workflows.',
  ...
  pl: {
    ...
    // Home Page
    'home.hero.title': 'Inżynier Oprogramowania & Technical Founder',
    'home.hero.description': 'Buduję produkty i systemy, które przekształcają złożone procesy w niezawodne oprogramowanie. Od aplikacji mobilnych po systemy backendowe, dostarczam kompleksowe rozwiązania z automatyzacją, czystą architekturą i kodem gotowym do produkcji.',
    'home.hero.viewProjects': 'Zobacz Wyróżnione Projekty',
    'home.hero.contactMe': 'Rozpocznij Projekt',
    'home.hero.downloadCV': 'Pobierz CV',
    'home.about.title': 'O mnie',
    'home.about.description': 'Doświadczony inżynier oprogramowania skupiający się na budowaniu skalowalnych systemów i produktów. Łączę wiedzę frontendową z silnymi umiejętnościami backendowymi, architekturą systemów i głębokim zrozumieniem pełnego cyklu życia oprogramowania.',
    'home.about.cyberskiller.title': 'Systemy i Bezpieczeństwo',
    'home.about.cyberskiller.subtitle': 'Buduję odporne aplikacje z podejściem security-first, niezawodną architekturą i głębokim zrozumieniem systemów.',
    ...
    // About Page
    'about.service.frontend.title': 'Full-Stack Development',
    'about.service.frontend.description': 'Buduję kompletne aplikacje webowe od frontendu do backendu, zapewniając płynną integrację i wydajność.',
    'about.service.backend.title': 'Architektura Systemów',
    'about.service.backend.description': 'Projektuję skalowalne API, bazy danych i infrastrukturę chmurową dla niezawodnych systemów produkcyjnych.',
    'about.service.mobile.title': 'Mobile & Cross-Platform',
    'about.service.mobile.description': 'Rozwijam natywne i cross-platformowe aplikacje mobilne z naciskiem na wydajność, możliwości offline i doświadczenie użytkownika.',
    'about.service.design.title': 'Inżynieria Produktów',
    'about.service.design.description': 'Inżynieryjnie produkty z czystą architekturą, automatyzacją i głębokim zrozumieniem procesów biznesowych.',
