const translations = {
  en: {
    ...
    'home.about.description': 'I am an Engineer-Developer bridging the gap between low-level logic (C++, Algorithms, Cybersecurity) and high-level user experiences (Kotlin/Android, React). With a background in systems administration and academic engineering, I build products that are not only responsive and accessible but architecturally sound.\n\nWhether I\'m optimizing SQL queries, managing Azure cloud infrastructure, or crafting MVVM-based mobile apps, I focus on performance, security, and the "Clean Code" philosophy.',
    'home.about.cyberskiller.title': 'CyberSkiller Challenge Finalist (6th in Poland) — I don\'t just write code; I understand how systems work and how to break them.',
    'home.about.cyberskiller.subtitle': 'Achievement in cybersecurity and systems administration with deep understanding of system architecture and security principles.',
  ...
  pl: {
    ...
    'home.about.description': 'Jestem Inżynierem-Programistą łączącym niskopoziomową logikę (C++, Algorytmy, Cyberbezpieczeństwo) z wysokopoziomowymi doświadczeniami użytkownika (Kotlin/Android, React). Z wykształcenia inżynier i doświadczeniem w administracji systemami, tworzę produkty, które są nie tylko responsywne i dostępne, ale również architektonicznie solidne.\n\nNiezależnie od tego, czy optymalizuję zapytania SQL, zarządzam infrastrukturą chmurową Azure, czy tworzę aplikacje mobilne w oparciu o MVVM, skupiam się na wydajności, bezpieczeństwie i filozofii \"Clean Code\".',

    'home.about.cyberskiller.title': 'Finalista CyberSkiller Challenge (6. miejsce w Polsce) — Nie tylko piszę kod; rozumiem, jak działają systemy i jak je złamać.',
    'home.about.cyberskiller.subtitle': 'Osiągnięcie w cyberbezpieczeństwie i administracji systemami z głębokim zrozumieniem architektury systemów i zasad bezpieczeństwa.',
