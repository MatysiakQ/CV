        ...
        >
          <div className="bg-background/80 backdrop-blur-md p-3 rounded-md shadow-lg flex flex-col sm:flex-row gap-3">
            <Button asChild size="lg" className="text-lg px-6 py-3" variant="default">
              <a ref={mobileRef} role="menuitem" href="/assets/cv/cv-mobile.pdf" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} aria-label={t('cv.mobile')}>
            ...
            <Button asChild size="lg" className="text-lg px-6 py-3" variant="outline">
              <a ref={desktopRef} role="menuitem" href="/assets/cv/cv-desktop.pdf" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} aria-label={t('cv.desktop')}>
                <span className="flex items-center gap-3">
